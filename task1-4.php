...
function multiplication($array,$multiply = 0) : int
{
...
{
    $newHolidaysArray = newHolidayArray($holidays);
...
function newHolidayArray($holidays, $newArray = []) : array
{
